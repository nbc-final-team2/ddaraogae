...
class WalkingRepositoryImpl @Inject constructor(
    ...
    override suspend fun insertWalkingData(walkingEntity: WalkingEntity, dogIdList: List<String>, mapImage: ByteArray?) {
        firebaseDateSource.insertWalkingData(walkingEntity.toDto(), dogIdList, mapImage)
    }
}