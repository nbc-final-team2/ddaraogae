...
class EditPetActivity : AppCompatActivity() {
    ...
    private fun changeDogData() = with(binding){
        ...
        btnEditCompleted.setOnClickListener {
            if(etName.text!!.isEmpty()) Toast.makeText(this@EditPetActivity, "이름은 필수 작성 항목입니다!", Toast.LENGTH_SHORT).show()
            else {
                ...
                //gender 추가 필요
                val changeDog = DogDto("", name, age, breed, memo, imageFile.toString())
    ...
    private fun changePet(changeDog:DogDto){
