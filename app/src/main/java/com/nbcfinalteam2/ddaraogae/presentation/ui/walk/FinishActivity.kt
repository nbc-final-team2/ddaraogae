...
//            intent.getParcelableArrayExtra("latLngList", LatLng::class.java)?.let {
//                drawPolyLine(it.toList())
//            }
//        } else {
//            intent.getParcelableArrayExtra("latLngList")?.let {
//                drawPolyLine(it.toList())
//            }
//        }
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            val latLngList: Array<LatLng>? = intent.getParcelableArrayExtra("latLngList", LatLng::class.java)
            latLngList?.let {
                drawPolyLine(it.toList())
            }
        } else {
