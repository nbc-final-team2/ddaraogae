...
class InsertWalkingDataUseCaseImpl @Inject constructor(
    ...
    override suspend fun invoke(walkingEntity: WalkingEntity, dogIdList: List<String>, mapImage: ByteArray?) =
        walkingRepository.insertWalkingData(walkingEntity, dogIdList, mapImage)
}